...
The normal CI suite includes the eight tests in `luaui/Tests/target_lists`.
They exercise target order and Stop, append/prepend, ground-attack boundaries,
queue skipping, independent Attack and Set Target state, pending Attack weapon
behavior, and command packet boundaries. Team 0 is the issuing team and team 1
